<div
    ...
    <header class="px-3 z-10 bg-white sticky sm:top-0 w-full py-2">

        <div class="border-b justify-between flex items-center py-2">
...
{{--                            </span>--}}
                                <p class="grow truncate text-sm font-[100]">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet asperiores aspernatur delectus dolores error
                                    illo illum incidunt iusto libero minus, necessitatibus nostrum obcaecati quam quasi quis rerum tempore vitae voluptas.
                                </p>
